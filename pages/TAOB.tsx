...
import { Check, Play, BookOpen, Infinity, MessageCircle, Send } from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <main className="pt-40 pb-32 px-6 md:px-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-20 md:space-y-32 text-stone-700">
            ...
            {/* Features Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 fade-up">
            ...
            {/* What you will learn */}
            <section className="max-w-4xl mx-auto fade-up">
              ...
              <div className="bg-white/40 border border-rose-100/50 p-6 sm:p-8 md:p-12 rounded-[2rem] shadow-sm">
            ...
            <section className="max-w-4xl mx-auto fade-up">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="bg-stone-900 text-white p-8 md:p-10 rounded-[2rem] flex flex-col items-center text-center">
                ...
                <div className="bg-rose-50 p-8 md:p-10 rounded-[2rem] flex flex-col items-center text-center border border-rose-100">
            ...
            {/* Payment & Form */}
            <section className="max-w-5xl mx-auto fade-up">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-0">
                
                {/* Payment Info */}
                <div className="lg:col-span-2 bg-stone-900 text-white p-8 sm:p-10 lg:p-12 rounded-[2rem] lg:rounded-r-none relative z-10 shadow-xl">
                  <h2 className="text-2xl md:text-3xl font-serif mb-8 md:mb-10 text-rose-100">Paiement</h2>
                  
                  <div className="space-y-6 md:space-y-8">
                    <div>
                      <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] text-stone-400 mb-1 md:mb-2">BaridiMob</p>
                      <p className="text-lg md:text-xl font-mono text-white tracking-wider break-all">0079999900XXXXXXXX</p>
                    </div>
                    
                    <div>
                      <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] text-stone-400 mb-1 md:mb-2">CCP</p>
                      <p className="text-lg md:text-xl font-mono text-white tracking-wider">00XXXXXX <span className="text-stone-400 text-sm">clé</span> XX</p>
                    </div>
                ...
                {/* Form */}
                <div className="lg:col-span-3 bg-white p-8 sm:p-10 lg:p-16 rounded-[2rem] lg:rounded-l-none border border-stone-100 shadow-xl lg:-ml-4">
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input type="email" id="email" className="w-full px-0 py-3 bg-transparent border-b border-stone-200 focus:border-rose-400 outline-none transition-colors font-light" placeholder="Votre email" required />
                      </div>
                    </div>
                    ...
                    <div className="pt-2 md:pt-4">
                      <label htmlFor="proof" className="block text-xs uppercase tracking-widest text-stone-500 mb-3 md:mb-4">Preuve de paiement</label>
                      <div className="border-2 border-dashed border-stone-200 rounded-xl p-6 md:p-8 text-center hover:border-rose-300 transition-colors cursor-pointer group">
                        ...
                        <label htmlFor="proof" className="cursor-pointer flex flex-col items-center">
                          ...
                          <span className="text-xs md:text-sm text-stone-400 font-light">Capture d'écran du virement</span>
                        </label>
                      </div>
                    </div>
